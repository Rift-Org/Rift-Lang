import { getCodeParser, getHighlightLinesRange, highlightCodeLines, notationDiff, notationErrorLevel, notationFocus, notationHighlight, } from '../parser/index.js';
import { resolveLanguage } from '../utils/index.js';
export const highlightPlugin = (md, { highlightLines = true, notationDiff: enabledDiff, notationErrorLevel: enabledErrorLevel, notationFocus: enabledFocus, notationHighlight: enabledHighlight, } = {}) => {
